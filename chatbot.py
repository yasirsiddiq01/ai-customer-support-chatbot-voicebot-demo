...
def find_best_answer(user_question: str, knowledge_base: list[dict]) -> dict:
    ...
    for item in knowledge_base:
        ...
        fuzzy_score = fuzz.token_set_ratio(user_question_clean, faq_question_clean)
        ...
        combined_score = (0.65 * fuzzy_score) + (0.35 * overlap_ratio * 100)
    ...
    if best_match is None or best_overlap_count == 0 or confidence < 0.60:
        return {
